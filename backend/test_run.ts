...
import { configureInject } from "./inject_config.ts";

configureInject();

export const automateWholeCompetition = (numPlayers: number, presetName?: string, exportToSpreadsheet?: boolean) => {
  ...
  if (exportToSpreadsheet) Api.mastersExportCompetition();
}

if (import.meta.main) {
  automateWholeCompetition(24, undefined, true);
}
