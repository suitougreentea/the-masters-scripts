    ...
    rounds: [
      { // 0
        ...
        winners: {
          numPerGroup: 4,
          numWildcard: 0,
          destinationRoundIndex: 1,
          destinationMethod: "standard",
          handicapMethod: "winnersDest",
        },
        losers: {
          numPerGroup: -1,
          destinationRoundIndex: 2,
          destinationMethod: "standard",
        },
      },
      { // 1
