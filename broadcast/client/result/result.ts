    ...
    return html`
      <div class="container">
        ...
        <div class="${classMap({
          ...
          ${(() => {
            if (this.data != null) {
              const stageMetadata = this.data.roundData.metadata
                .stages[this.data.currentStageIndex];
              const stageData =
              ...
              return html`
                <div class="stage-result-container">
                  <div>
                    ...
                    <masters-stage-players .data="${stageData
                      .players}"></masters-stage-players>
                  </div>
                  <div>
                    <div class="heading">${stageMetadata.name} リザルト</div>
                    <masters-stage-result
                      .data="${stageData.result}"
                  ...
                  ${(() => {
                      ...
                      return html`
                        <div>
                          ...
                          <masters-qualifier-score
                            .data="${roundData.qualifierScore.players}"
                            .stageMetadata="${roundData.metadata.stages}"
                          ></masters-qualifier-score>
                        </div>
                      `;
                    }
                    ...
                    if (
                      ...
                      return html`
                        <div>
                          ...
                          <masters-qualifier-result .data="${roundData
                            .qualifierResult
                            .result}"></masters-qualifier-result>
                        </div>
                      `;
                    }
                    return undefined;
                    ...
                    (supplementComparison, supplementComparisonIndex) => {
                      ...
                      if (supplementComparison.comparison.length > 0) {
                        return html`
                          <div>
                            <div class="heading">${supplementComparisonMetadata
                              .name}</div>
                            <masters-supplement-comparison
                              .data="${supplementComparison.comparison}"
                            ></masters-supplement-comparison>
                          </div>
                        `;
                      }
        ...
        ${(() => {
          if (this.data?.nextStageName != null) {
            return html`
              <div class="next-stage-name">
                <span>Next &gt;&gt; </span><span>${this.data
                  .nextStageName}</span>
              </div>
            `;
          } else {
            return html`
              <div class="next-stage-name"></div>
            `;
          }
        })()}
      </div>
